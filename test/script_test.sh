...
echo "\nduplicatepipe -> \033[32mOK\033[0m" >> rendu
./lem-in < maps/duplicatepipe >> rendu
echo "\nduplicatepipe1 -> \033[32mOK\033[0m" >> rendu
./lem-in < maps/duplicatepipe1 >> rendu
echo "\nempty" >> rendu
./lem-in < maps/empty >> rendu
echo "\nempty_line" >> rendu
./lem-in < maps/empty_line >> rendu
echo "\nillegalname" >> rendu
...
echo "\nloop -> \033[32mOK\033[0m" >> rendu
./lem-in < maps/loop >> rendu
echo "\nloop1" >> rendu
./lem-in < maps/loop1 >> rendu
echo "\nloop2" >> rendu
./lem-in < maps/loop2 >> rendu
echo "\nnegants" >> rendu
./lem-in < maps/negants >> rendu
echo "\nnoants" >> rendu
./lem-in < maps/noants >> rendu
echo "\nnoend" >> rendu
./lem-in < maps/noend >> rendu
echo "\nnopath" >> rendu
./lem-in < maps/nopath >> rendu
echo "\nnostart" >> rendu
